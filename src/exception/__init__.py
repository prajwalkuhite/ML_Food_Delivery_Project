...
class CustomException(Exception):
    ...
    def get_detailed_error_message(error_message:Exception, error_details:sys)->str:
        _,_,excep_tb = error_details.exc_info()

        exception_block_line_number = excep_tb.tb_frame.f_lineno
        try_block_line_number = excep_tb.tb_lineno
        file_name = excep_tb.tb_frame.f_code.co_filename
